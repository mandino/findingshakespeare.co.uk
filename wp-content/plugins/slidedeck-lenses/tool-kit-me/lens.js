(function($){
    SlideDeckLens['tool-kit-me'] = function(slidedeck){
    ...
    $(document).ready(function(){
        $('.lens-tool-kit-me .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-tool-kit-me')) == 'undefined' || $.data(this, 'lens-tool-kit-me') == null){
                $.data(this, 'lens-tool-kit-me', new SlideDeckLens['tool-kit-me'](this));
            }
        });
    });
})(jQuery);