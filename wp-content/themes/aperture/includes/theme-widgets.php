...
?>
    ...
    <h3 id="popular"><?php echo $text; ?></h3>
        ...
        <?php
		global $post;
		$popular = get_posts('caller_get_posts=1&orderby=comment_count&showposts='.$amount);
		foreach($popular as $post) :
			setup_postdata($post);
 		?>

        <li>
            <?php woo_image('height=50&width=50&class=thumbnail&single=true'); ?>  
            <div class="content">
...
?>
   ...
   <h3 id="photos"><?php echo $text; ?></h3>
        <ul class="news">
			...
			$idObj = get_category_by_slug( get_option('woo_blog_cat') ); 
			$cat_id = $idObj->term_id;
             $posts = query_posts('cat=-'.$cat_id.'&showposts=5'); 
